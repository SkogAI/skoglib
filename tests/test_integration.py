...
""",
    ...
    def test_mock_successful_execution(self):
        ...
        result = run_executable(
            self.mock_executables["mock_success"], ["arg1", "arg2", "arg3"]
        )
    ...
    def test_mock_failing_execution_no_check(self):
        ...
        result = run_executable(
            self.mock_executables["mock_fail"], check_exit_code=False
        )
    ...
    def test_mock_timeout_execution(self):
        ...
        with self.assertRaises(ExecutionError) as cm:
            run_executable(self.mock_executables["mock_timeout"], timeout=1.0)
    ...
    def test_mock_environment_execution(self):
        ...
        result = run_executable(self.mock_executables["mock_env"], env_vars=env_vars)
