...
class TestEnvironmentVariableLoading(TestCase):
    ...
    def setUp(self):
        ...
        self.original_env = {}
        env_vars = ["SKOGAI_DEFAULT_TIMEOUT", "SKOGAI_MAX_OUTPUT_SIZE", 
                   "SKOGAI_LOG_LEVEL", "SKOGAI_SEARCH_PATHS"]
    ...
    def test_load_config_all_variables(self):
        ...
        self.assertEqual(config.executable_search_paths, ["/custom/bin", "/another/path"])
...
class TestThreadSafety(TestCase):
    ...
    def test_concurrent_config_access(self):
        ...
        self.assertEqual(len(set(results)), 1, "All threads should get the same config instance")
    ...
    def test_concurrent_config_with_reset(self):
        ...
        self.assertLessEqual(len(unique_ids), 2, 
                           "Should have at most 2 different config instances")
